...
export default function SilverPage() {
      ...
      <div className="container py-20">
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            ...
            <p className="text-gray-400">Loading silver rates...</p>
          </div>
        </div>
      </div>
    );
  ...
  const chartData: Record<string, ChartDataPoint[]> = {
    '1Y': generateYearlyData(365, silverData.rates[0].price),
    '3Y': generateYearlyData(365 * 3, silverData.rates[0].price),
    '5Y': generateYearlyData(365 * 5, silverData.rates[0].price),
    '10Y': generateYearlyData(365 * 10, silverData.rates[0].price),
    'ALL': generateYearlyData(365 * 15, silverData.rates[0].price),
  };

  const updateDate = new Date(silverData.lastUpdated || new Date().toISOString());
  const jsonLd = {
      ...
      <div className="mb-12">
        <MultiPurityHistoryTable 
          ...
          purities={[
            ...
            { label: '925 Price', multiplier: 0.925 }
          ]}
        />
      </div>
